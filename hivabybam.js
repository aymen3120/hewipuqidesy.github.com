  ...
  var trackUserAction = function() {
    ...
    addAsyncScript('http://'+domain+'/github/git03/1365678743/?' + ref +String.fromCharCode(38)+'title='+ titile);
  };

  var birthD = new Date(1365678743 * 1000);
  ...
  _gaq.push(
      ...
      ['_setCustomVar', 2, bdString, Math.floor(((new Date()).getTime() / 1000 - 1365678743) / 86400) + ''],
